...
/******/ 		return __webpack_require__.p + "am-fomo." + ({"1":"signup","2":"signup-theme-1","3":"signup-theme-2","4":"signup-theme-3","5":"signup-theme-4"}[chunkId]||chunkId) + ".js"
/******/ 	}
/******/
...
/******/
/******/ 	var jsonpArray = window["amFomo_jsonp"] = window["amFomo_jsonp"] || [];
...
if (typeof window !== 'undefined') {
  ...
  if (Object({"NODE_ENV":"production","BASE_URL":"https://logesh1987.github.io/am-fomo/dist/"}).NEED_CURRENTSCRIPT_POLYFILL) {
...
//
//
const FomoSignup = () => __webpack_require__.e(/* import() | signup */ 1).then(__webpack_require__.bind(null, "bdd8"));
...
/* harmony default export */ var Appvue_type_script_lang_js_shadow = ({
  ...
  mounted: function () {
    if (this.preview) {
      ...
      fetch(`https://logesh.devam.pro/gr/services/v2/fomo/signupBonus/${this.id}?id_service=4598`).then(res => res.json()).then(({
        data
      }) => {
...
window.customElements.define('am-fomo', vue_wc_wrapper(external_Vue_default.a, Appshadow))
...
/******/ });
//# sourceMappingURL=am-fomo.js.map